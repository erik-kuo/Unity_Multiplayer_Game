...
namespace GameServer
{
	class Server
	{
		...
		public static void Start(int _maxPlayers, int _port)
		{
			...
			tcpListener = new TcpListener(IPAddress.Parse(Constants.ServerIP), Port);
			tcpListener.Start();
		...
		private static void InitializeServerData()
		{
			...
			packetHandlers = new Dictionary<int, PacketHandler>()
			{
				...
				{ (int)ClientPackets.player2DPosition, ServerHandle.Player2DPosition },
				{ (int)ClientPackets.CPBUpdate, ServerHandle.CPBUpdate },
				...
				{ (int)ClientPackets.characterMovement, ServerHandle.CharacterMovement },
				{ (int)ClientPackets.animatorMovement, ServerHandle.AnimatorMovement }
			};
